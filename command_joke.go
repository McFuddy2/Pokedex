...
func callbackJoke (cnfg *config, args ...string) error {
	jokes := []string{
		"Why did the Pikachu cross the road? To get to the other Psyd....uck!",
		"What do you call a nerdy Pikachu? A Geek-achu!",
		"Why did Meowth go to school? To improve his Meowthematics!",
		"What do you call a surprised Pikachu? A shocked!",
		"Did you hear about the Charizard who got into modeling? He’s really hot!",
		"Why did the Ditto go to therapy? It was having an identity crisis.",
		"What does a Pokemon scientist use to catch invisible Pokemon? Psyducktape.",
		"Golem started a 1 man band, called ROCK AND ROLL!",
